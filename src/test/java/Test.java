...
public class Test {
    ...
    public static void main(String[] args) {
        Test st = new Test();
        st.add("sugger", 10, 10,"2","");
        st.update("1", 100);
        st.bill("1", 10);
    }

    public void add(String name, int qty, double price,String unit,String pid) {
    ...
    public void update(String id, int nqty) {
        ...
        String unit=v3.s_unit;
        String pid=v3.s_pid;

        map.put(id, new stock(sid, sname, cqty, price,unit,pid));
